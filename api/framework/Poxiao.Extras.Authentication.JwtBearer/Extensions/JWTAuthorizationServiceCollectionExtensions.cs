...
public static class JWTAuthorizationServiceCollectionExtensions
{
    ...
    {
        // 植入 Poxiao 框架
        var poxiaoAssembly = JWTEncryption.GetFrameworkContext(Assembly.GetCallingAssembly());

        // 获取添加授权类型
        var authorizationServiceCollectionExtensionsType = poxiaoAssembly.GetType("Microsoft.Extensions.DependencyInjection.AuthorizationServiceCollectionExtensions");
