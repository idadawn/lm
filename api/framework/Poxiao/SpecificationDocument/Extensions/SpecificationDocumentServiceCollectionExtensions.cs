...
public static class SpecificationDocumentServiceCollectionExtensions
{
    ...
    public static IMvcBuilder AddSpecificationDocuments(
    ...
    /// <param name="configure">自定义配置</param>
    /// <returns>服务集合</returns>
    public static IServiceCollection AddSpecificationDocuments(
    ...
    )
    {
        ...
        services.AddSwaggerGen(options =>
            SpecificationDocumentBuilder.BuildGen(options, configure)
        );
    ...
    private static void AddMiniProfiler(IServiceCollection services)
    {
        ...
        services.AddMiniProfiler(options =>
        {
            ...
            {
                if (!req.Headers.ContainsKey("request-from"))
                    return false;
                return true;
            };
