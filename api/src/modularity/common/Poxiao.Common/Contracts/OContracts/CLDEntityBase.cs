...
/// </summary>
[SuppressSniffer]
public abstract class CLDEntityBase : OEntityBase<string>, IOCreatorTime, IODeleteTime
{
    /// <summary>
    /// 获取或设置 创建时间.
    /// </summary>
    ...
    public virtual void Create()
    {
        ...
        if (!string.IsNullOrEmpty(tenantId))
        {
            this.TenantId = TenantId == null ? tenantId : TenantId;
        }
    }
