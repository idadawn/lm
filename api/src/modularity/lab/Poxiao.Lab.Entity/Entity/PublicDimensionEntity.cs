...
/// 公共维度定义.
/// </summary>
[SugarTable("LAB_PUBLIC_DIMENSION")]
[Tenant(ClaimConst.TENANTID)]
public class PublicDimensionEntity : CLDEntityBase
{
    /// <summary>
    /// 维度名称（如：长度、层数、密度）.
    /// </summary>
    [SugarColumn(ColumnName = "F_DIMENSION_NAME", IsNullable = false, Length = 100)]
    public string DimensionName { get; set; }

    /// <summary>
    /// 维度键名（如：length、layers、density）.
    /// </summary>
    [SugarColumn(ColumnName = "F_DIMENSION_KEY", IsNullable = false, Length = 100)]
    public string DimensionKey { get; set; }

    /// <summary>
    /// 维度值类型（decimal、int、text）.
    /// </summary>
