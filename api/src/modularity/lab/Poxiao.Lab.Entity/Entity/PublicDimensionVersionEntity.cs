...
/// 公共维度版本快照.
/// </summary>
[SugarTable("LAB_PUBLIC_DIMENSION_VERSION")]
[Tenant(ClaimConst.TENANTID)]
public class PublicDimensionVersionEntity : CLDEntityBase
{
    /// <summary>
    /// 公共维度ID.
    /// </summary>
    [SugarColumn(ColumnName = "F_DIMENSION_ID", IsNullable = false, Length = 50)]
