...
/// 单片性能原始数据实体.
/// </summary>
[SugarTable("LAB_SINGLE_SHEET_RAW_DATA")]
[Tenant(ClaimConst.TENANTID)]
public class SingleSheetRawDataEntity : CLDEntityBase
{
    /// <summary>
    /// 原始炉号（B列，包含K标识）.
    /// </summary>
