...
public class DataEncryptionTests : IClassFixture<WebApplicationFactory<TestProject.Startup>>
{
    ...
    /// <returns></returns>
    [Theory]
    [InlineData("/DataEncryptionTests/TestMD5Encrypt", "Poxiao", true)]
    [InlineData("/DataEncryptionTests/TestMD5Encrypt", "Poxiao", false)]
    ...
    /// <returns></returns>
    [Theory]
    [InlineData("/DataEncryptionTests/TestMD5Compare", "Poxiao", "08C5318BD8A478A88E6D594A0142AE6C", true)]
    [InlineData("/DataEncryptionTests/TestMD5Compare", "Poxiao", "08c5318bd8a478a88e6d594a0142ae6c", false)]
