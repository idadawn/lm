...
public class ViewEngineTests : IClassFixture<WebApplicationFactory<TestProject.Startup>>
{
    ...
    /// <returns></returns>
    [Theory]
    [InlineData("/ViewEngineTests/TestRunCompile", "Poxiao")]
    [InlineData("/ViewEngineTests/TestRunCompileFromCached", "Poxiao")]
    ...
    /// <returns></returns>
    [Theory]
    [InlineData("/ViewEngineTests/TestRunCompileStrongly", "Poxiao", 1, 2, 3)]
    [InlineData("/ViewEngineTests/TestRunCompileStronglyFromCached", "Poxiao", 1, 2, 3)]
...
", content);
    ...
    /// <returns></returns>
    [Theory]
    [InlineData("/ViewEngineTests/TestRunCompileAssembly", "Poxiao")]
    [InlineData("/ViewEngineTests/TestRunCompileAddAssemblyAndNamespace", "Poxiao")]
...
", content);
    ...
    public async Task Test_RunCompile_Strongly_Invoke_ClassMethod(string url)
    {
        ...
        Assert.Equal($@"Hello 10, Poxiao, -=123=-", content);
    }
}