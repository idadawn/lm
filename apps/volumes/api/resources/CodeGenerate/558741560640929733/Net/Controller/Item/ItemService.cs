...
using Poxiao.system.Entitys.Dto.Item;
using Poxiao.system.Entitys;
using Poxiao.system.Interfaces;
using Mapster;
...
namespace Poxiao.system;

/// <summary>
/// 业务实现：物料信息.
/// </summary>
[ApiDescriptionSettings(Tag = "system", Name = "Item", Order = 200)]
