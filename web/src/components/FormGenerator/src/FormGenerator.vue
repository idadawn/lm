<template>
  <div :class="`${prefixCls}`">
    ...
    <RightPanel v-bind="getRightPanelBind" @relationChange="onRelationChange" />
...
<script lang="ts" setup>
  ...
  import { saveDrawingList } from '/@/components/FormGenerator/src/helper/db';
  ...
  const debounceSaveDrawingList = useDebounceFn(saveDrawingList, 300);
