<template>
  <a-form-item label="提示文本">
    <a-input v-model:value="activeData.title" placeholder="请输入提示文本" />
  </a-form-item>
  <a-form-item label="辅助文本">
    <jnpf-textarea v-model:value="activeData.description" placeholder="请输入辅助文本" :rows="2" />
  </a-form-item>
  ...
  <a-form-item label="按钮文字" v-if="activeData.closable">
    <a-input v-model:value="activeData.closeText" :maxlength="10" placeholder="请输入按钮文字" />
  </a-form-item>
</template>
