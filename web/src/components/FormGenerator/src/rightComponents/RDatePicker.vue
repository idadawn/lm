<template>
  <a-form-item label="格式">
    <jnpf-select v-model:value="activeData.format" placeholder="请选择格式" :options="formatOptions" @change="onFormatChange" />
  </a-form-item>
  ...
  <a-form-item>
    <a-checkbox v-model:checked="activeData.__config__.defaultCurrent" class="float-right !-mr-8px" @change="resetValue">默认为当前系统时间</a-checkbox>
  </a-form-item>
  ...
  <template v-if="activeData.__config__.startTimeRule">
    <a-form-item label="类型">
      <jnpf-select v-model:value="activeData.__config__.startTimeType" placeholder="请选择类型" :options="typeOptions" @change="onStartTimeTypeChange" />
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.startTimeType == 2">
          <jnpf-select v-model:value="activeData.__config__.startRelationField" placeholder="请选择关联日期选择" :options="formFieldsOptions" />
        </template>
  ...
  <template v-if="activeData.__config__.endTimeRule">
    <a-form-item label="类型">
      <jnpf-select v-model:value="activeData.__config__.endTimeType" placeholder="请选择类型" :options="typeOptions" @change="onEndTimeTypeChange" />
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.endTimeType == 2">
          <jnpf-select v-model:value="activeData.__config__.endRelationField" placeholder="请选择关联日期选择" :options="formFieldsOptions" />
        </template>
