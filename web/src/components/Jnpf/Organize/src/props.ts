...
export const depSelectProps = {
  ...baseProps,
  ableDepIds: { type: Array as PropType<string[]>, default: () => [] },
  modalTitle: { type: String, default: '选择部门' },
};
export const posSelectProps = {
  ...depSelectProps,
  ablePosIds: { type: Array as PropType<string[]>, default: () => [] },
...
export const userSelectProps = {
  ...posSelectProps,
  ableRoleIds: { type: Array as PropType<string[]>, default: () => [] },
  ableGroupIds: { type: Array as PropType<string[]>, default: () => [] },
  ableUserIds: { type: Array as PropType<string[]>, default: () => [] },
