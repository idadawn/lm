  ...
  <div class="h-full" @click.stop="handleClick(item)">
    ...
    <template v-if="item.jnpfKey === 'tab'">
      <a-tabs
        ...
        <a-tab-pane v-for="(child, i) in item.children" :key="i">
          <template #tab>
...
<script lang="ts" setup>
  import { ref, defineAsyncComponent, markRaw, inject, computed } from 'vue';
  ...
  function handleTabClick() {
    ...
    const subItem = props.item.children[active].children;
