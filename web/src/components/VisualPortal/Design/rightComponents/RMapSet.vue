  ...
  <div>
    ...
    <template v-if="activeData.option.styleType == 1 || activeData.option.styleType == 4">
      ...
      <a-form-item>
        ...
        <a-input-number v-model:value="activeData.option.showNumber" :min="0" :max="2000" />
      </a-form-item>
    ...
    <template v-if="activeData.option.styleType == 4 && showType == 'pc'">
      ...
      <a-form-item label="标题名称">
        <a-input v-model:value="activeData.option.barTitleText" placeholder="请输入标题名称" />
      </a-form-item>
      <a-form-item label="字体大小">
    ...
    <template v-if="(activeData.option.styleType == 1 || activeData.option.styleType == 4) && showType == 'pc'">
      ...
      <a-form-item label="轮播间隔" v-if="activeData.option.autoCarousel">
        <a-input-number v-model:value="activeData.option.autoCarouselTime" placeholder="请输入轮播间隔" :min="100" :max="500000" addon-after="ms" />
      </a-form-item>
    </template>
