  ...
  <a-collapse-panel>
    ...
    <template v-if="activeData.option.tooltipShow">
      ...
      <a-form-item label="字体颜色">
        <jnpf-color-picker v-model:value="activeData.option.tooltipTextStyleColor" size="small" />
      </a-form-item>
      <a-form-item label="背景色">
        <jnpf-color-picker v-model:value="activeData.option.tooltipBgColor" size="small" />
      </a-form-item>
    </template>
  </a-collapse-panel>
</template>
