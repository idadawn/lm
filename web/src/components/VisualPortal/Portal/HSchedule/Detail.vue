<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="查看日程">
    <a-form class="!mx-20px" :colon="false" :model="dataForm" ref="formElRef" :labelCol="{ style: { width: '80px' } }">
      ...
      <a-form-item label="开始时间">
        <p>{{ dayjs(dataForm.startDay).format('YYYY-MM-DD HH:mm') }} </p>
      </a-form-item>
      <a-form-item label="结束时间">
        <p>{{ dayjs(dataForm.endDay).format('YYYY-MM-DD HH:mm') }} </p>
      </a-form-item>
