<template>
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" width="280px" class="full-drawer message-drawer" :closeFunc="handleClose">
      ...
      <a-dropdown>
        <template #overlay>
          <a-menu @click="handleTypeClick">
            ...
            <a-menu-item key="系统">系统</a-menu-item>
            <a-menu-item key="流程">流程</a-menu-item>
            <a-menu-item key="公告">公告</a-menu-item>
            <a-menu-item key="全部">日程</a-menu-item>
          </a-menu>
        </template>
    ...
    <ScrollContainer ref="infiniteBody" class="msg-list">
      ...
      <Empty :image="simpleImage" v-if="!list.length" />
    </ScrollContainer>
