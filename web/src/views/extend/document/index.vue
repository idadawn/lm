<template>
  <div class="page-content-wrapper document-wrapper bg-white">
      ...
      <a-tab-pane key="all">
        ...
        <div class="container">
          ...
          <div class="jnpf-common-search-box">
            <BasicForm @register="registerAllForm" @submit="handleAllSubmit" @reset="handleAllReset"></BasicForm>
...
<script lang="ts" setup>
  ...
  const [registerAllTable, { reload: reloadAllTable }] = useTable({
    ...
    columns: [
      ...
      { title: '创建日期', dataIndex: 'creatorTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    ],
  ...
  const [registerShareOutTable, { getForm: getShareOutForm, reload: reloadShareOutTable }] = useTable({
    ...
    columns: [
      { title: '文件名', dataIndex: 'fullName' },
      { title: '大小', dataIndex: 'fileSize', width: 90 },
      { title: '共享日期', dataIndex: 'shareTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
  ...
  const [registerTrashTable, { getForm: getTrashForm, reload: reloadTrashTable }] = useTable({
    ...
    columns: [
      { title: '文件名', dataIndex: 'fullName' },
      { title: '大小', dataIndex: 'fileSize', width: 90 },
      { title: '删除日期', dataIndex: 'deleteTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
