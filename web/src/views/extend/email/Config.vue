  ...
  const schemas: FormSchema[] = [
    {
      ...
      label: 'POP3服务',
      component: 'Input',
      componentProps: { placeholder: 'POP3服务' },
      rules: [{ required: true, trigger: 'blur', message: 'POP3服务不能为空' }],
    },
    {
      field: 'pop3Port',
      label: 'POP3端口',
      ...
      rules: [{ required: true, trigger: 'blur', message: 'POP3端口不能为空' }],
    },
    {
      field: 'smtpHost',
      label: 'SMTP服务',
      component: 'Input',
      componentProps: { placeholder: 'SMTP服务' },
      rules: [{ required: true, trigger: 'blur', message: 'SMTP服务不能为空' }],
    },
    {
      field: 'smtpPort',
      label: 'SMTP端口',
      component: 'InputNumber',
      componentProps: { min: 0, max: 999999 },
      rules: [{ required: true, trigger: 'blur', message: 'SMTP端口不能为空' }],
    },
    {
      field: 'senderName',
      label: '显示名称',
      component: 'Input',
      componentProps: { placeholder: '显示名称' },
      rules: [{ required: true, trigger: 'blur', message: '显示名称不能为空' }],
    },
    {
      field: 'account',
      label: '邮箱地址',
      ...
      rules: [{ required: true, trigger: 'blur', message: '邮箱地址不能为空' }],
    },
    {
      field: 'password',
      label: '邮箱密码',
