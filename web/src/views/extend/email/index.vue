<template>
  <div class="page-content-wrapper bg-white">
    <div class="page-content-wrapper-center email-wrapper">
  ...
  const getColumns = computed<any[]>(() => {
    if (state.activeKey === 'inBox' || state.activeKey === 'star') {
      return [
        ...
        { title: '时间', dataIndex: 'fdate', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    ...
    return [
      ...
      { title: '主题', dataIndex: 'subject' },
      { title: '时间', dataIndex: 'creatorTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    ];
  });
