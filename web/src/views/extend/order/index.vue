    ...
    <div class="page-content-wrapper-center">
      <div class="page-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-ym icon-ym-btn-add" @click="handleAdd()">新建订单</a-button>
          </template>
          ...
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'currentState'">
              ...
              <a-tag v-else-if="record.currentState == 4">流程撤回</a-tag>
...
<script lang="ts" setup>
  ...
  const columns: BasicColumn[] = [
    ...
    { title: '订单日期', dataIndex: 'orderDate', width: 150, format: 'date|YYYY-MM-DD HH:mm', sorter: true },
  ...
  const planColumns: BasicColumn[] = [
    { title: '收款日期', dataIndex: 'receivableDate', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
