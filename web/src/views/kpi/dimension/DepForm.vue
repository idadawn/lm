<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="getTitle" @ok="handleSubmit">
    ...
    <div class="page-content-wrapper">
      <div class="page-content-wrapper-left" style="height: 340px">
        <BasicLeftTree
          :treeData="treeData"
          :loading="treeLoading"
          :showSearch="false"
          ...
          v-model:selectKeysId="selectKeysId"
...
<script lang="ts" setup>
  ...
  import { reactive, ref, unref, computed, onMounted, toRefs } from 'vue';
