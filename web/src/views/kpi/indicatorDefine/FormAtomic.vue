  ...
  <div class="page-content-wrapper">
    ...
    <div class="page-content-wrapper-left" style="height: auto">
      <a-tabs v-model:activeKey="activeKey_left" type="card">
        <a-tab-pane key="1" tab="模型列表"> </a-tab-pane>
      ...
      <div class="page-content-wrapper-content">
        <a-form layout="vertical" :model="formState" :label-col="{ span: 8 }" :wrapper-col="{ span: 24 }">
          ...
          <a-form-item label="选择模型中表示指标的列">
            <a-select
              ref="select"
              v-model:value="formState.targetColumn"
              show-search
              :filter-option="filterOption"
              placeholder="请选择"
              @change="targetColumnChange">
          ...
          <a-form-item label="维度（模型中表示细分维度的列）">
            <depSelect
              :dataArr="targetColumnArrWeidu"
              :checkedArr="targetCheckedArrWeidu"
              @depSelectEmits="depSelectEmitsFun"
              @depSelectItemEmits="depSelectItemEmitsFun"></depSelect>
          </a-form-item>
        ...
        <div style="margin-top: 40px" v-if="timeSetting">
          ...
          <a-form
            ...
            <a-form-item label="时间粒度">
              ...
              <a-select
                ref="select"
                v-if="formState.data_type !== 'RealTime'"
                v-model:value="dateSetting.date_lidu"
                placeholder="请选择">
