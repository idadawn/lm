  ...
  <div class="page-content-wrapper">
    ...
    <div class="page-content-wrapper-center">
      <div class="page-content-wrapper-content">
        ...
        <a-form class="modelFormClass" layout="vertical" :model="formState" :label-col="{ span: 8 }"
          :wrapper-col="{ span: 14 }">
          <a-form-item label="派生自" :rules="[{ required: true, message: '请选择派生自' }]">
            <a-select ref="select" v-model:value="formState.derivedFromValue" show-search :filter-option="filterOption"
              :options="derivedFromArr" :fieldNames="{
                label: 'name',
                value: 'id',
              }" placeholder="请选择" @change="derivedFromChange">
            </a-select>
          </a-form-item>
          <a-form-item label="派生类型" :rules="[{ required: true, message: '请选择派生类型' }]">
            <a-select ref="select" v-model:value="formState.derivedTypeValue" show-search :options="derivedTypeArr"
              :fieldNames="{
                label: 'fullName',
                value: 'enCode',
              }" placeholder="请选择">
          ...
          <template v-if="formState.derivedTypeValue === 'POP'">
            <a-form-item label="计算区间">
              <a-select ref="select" v-model:value="formState.calculationIntervalValue"
                @change="calculationIntervalChange" placeholder="请选择">
                <a-select-option value="Year">年</a-select-option>
                <a-select-option value="Quarter">季</a-select-option>
                <a-select-option value="Month">月</a-select-option>
                <a-select-option value="Week">周</a-select-option>
          ...
          <template v-if="formState.derivedTypeValue === 'Moving'">
            ...
            <a-form-item label="计算区间结束于">
              <a-radio-group v-model:value="formState.lastLine" name="radioGroup">
                ...
                <a-radio value="last">相对于当前行的第<a-input-number style="width: 80px !important"
                    v-model:value="formState.endLine" />
                  行</a-radio>
              </a-radio-group>
            </a-form-item>
          </template>
          ...
          <template v-if="formState.derivedTypeValue === 'Ranking'">
            <a-form-item label="排名类型">
              <a-select ref="select" v-model:value="formState.rankingType" :options="rankingTypeArr" :fieldNames="{
                label: 'fullName',
                value: 'enCode',
              }" placeholder="请选择">
              </a-select>
        ...
        <div>
          ...
          <a-form class="modelFormClass" layout="vertical" :model="nameDescribe" ref="formRefDescribe"
            :rules="rulesDescribe" :label-col="{ span: 8 }" :wrapper-col="{ span: 14 }">
