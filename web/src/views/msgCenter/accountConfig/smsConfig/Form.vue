...
<script lang="ts" setup>
  ...
  const schemas: FormSchema[] = [
    ...
    },
    {
      ...
      rules: [{ required: true, trigger: 'change', message: '请选择渠道', type: 'number' }],
    },
    {
      field: 'smsSignature',
      label: '短信签名',
      ...
      componentProps: { placeholder: '请输入短信签名' },
      rules: [{ required: true, trigger: 'blur', message: '请输入短信签名' }],
    },
    {
      ...
      componentProps: { placeholder: '请输入AccessKey ID' },
      rules: [{ required: true, trigger: 'blur', message: '请输入AccessKey ID' }],
    },
    {
      ifShow: ({ values }) => values.channel === 1,
      field: 'appSecret',
      ...
      helpMessage: '请在“阿里云的AccessKey管理-安全信息管理”页中获得',
      componentProps: { placeholder: '请输入AccessKey Secret' },
      rules: [{ required: true, trigger: 'blur', message: '请输入AccessKey Secret' }],
    },
    {
      ifShow: ({ values }) => values.channel === 1,
      field: 'endPoint',
      ...
      componentProps: { placeholder: '请输入EndPoint' },
      rules: [{ required: true, trigger: 'blur', message: '请输入EndPoint' }],
    },
    {
      ...
      componentProps: { placeholder: '请输入SecretId' },
      rules: [{ required: true, trigger: 'blur', message: '请输入SecretId' }],
    },
    {
      ifShow: ({ values }) => values.channel === 2,
      field: 'secretKey',
      ...
      component: 'InputPassword',
      helpMessage: '请在”腾讯云的访问管理-访问密钥- API密钥管理”⻚中获得',
      componentProps: { placeholder: '请输入SecretKey' },
      rules: [{ required: true, trigger: 'blur', message: '请输入SecretKey' }],
    },
    {
      ifShow: ({ values }) => values.channel === 2,
      field: 'sdkAppId',
      ...
      componentProps: { placeholder: '请输入SDK AppID' },
      rules: [{ required: true, trigger: 'blur', message: '请输入SDK AppID' }],
    },
    {
      ifShow: ({ values }) => values.channel === 2,
      field: 'appKey',
      ...
      component: 'InputPassword',
      helpMessage: '请在”腾讯云的应⽤管理-应⽤列表”⻚中获得',
      componentProps: { placeholder: '请输入App Key' },
      rules: [{ required: true, trigger: 'blur', message: '请输入SDK Key' }],
    },
    {
      ifShow: ({ values }) => values.channel === 2,
      field: 'zoneName',
      ...
      componentProps: { placeholder: '请输入地域域名' },
      rules: [{ required: true, trigger: 'blur', message: '请输入地域域名' }],
    },
    {
      ifShow: ({ values }) => values.channel === 2,
      field: 'zoneParam',
      ...
      componentProps: { placeholder: '请输入地域域名' },
      rules: [{ required: true, trigger: 'blur', message: '请输入地域参数' }],
    },
    {
      field: 'sortCode',
      label: '排序',
