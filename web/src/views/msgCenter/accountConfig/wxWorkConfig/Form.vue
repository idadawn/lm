  ...
  <BasicModal v-bind="$attrs" @register="registerModal" :title="getTitle" showOkBtn @ok="handleSubmit">
    <BasicForm @register="registerForm">
      <template #appSecret="{ model, field }">
        <a-input-password v-model:value="model[field]" placeholder="请输入应用Secret" show-password>
          <template #addonAfter>
...
<script lang="ts" setup>
  ...
  const schemas: FormSchema[] = [
    ...
    },
    {
      ...
      label: '企业ID',
      component: 'Input',
      helpMessage: '请在“企业微信管理后台-我的企业-企业信息”页中获得',
      componentProps: { placeholder: '请输入企业ID' },
      rules: [{ required: true, trigger: 'blur', message: '请输入企业ID' }],
    },
    {
      field: 'appId',
      label: '应用AgentID',
      component: 'Input',
      helpMessage: '请在“企业微信管理后台-应用管理-应用-详情”页中获得',
      componentProps: { placeholder: '请输入应用AgentID' },
      rules: [{ required: true, trigger: 'blur', message: '请输入应用AgentID' }],
    },
    {
      field: 'appSecret',
      label: '应用Secret',
      ...
      helpMessage: '请在“企业微信管理后台-应用管理-应用-详情”页中获得',
      slot: 'appSecret',
      rules: [{ required: true, trigger: 'blur', message: '请输入应用Secret' }],
    },
    {
      field: 'sortCode',
      label: '排序',
