      ...
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label="编码" name="enCode">
            <a-input v-model:value="dataForm.enCode" placeholder="请输入编码" allowClear />
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="24">
          <div class="msg-pane">
            ...
            <div class="table-add-action" @click="addTemplateData">
              <a-button type="link" preIcon="icon-ym icon-ym-btn-add">添加模板</a-button>
            </div>
          </div>
        </a-col>
      </a-row>
...
<script lang="ts" setup>
  ...
  function init(data) {
    ...
    state.title = state.dataForm.id ? '编辑发送配置' : '新建发送配置';
    initData();
