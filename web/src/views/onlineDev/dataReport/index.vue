      ...
      <div class="page-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <jnpf-upload-btn :url="reportServer + '/api/datareport/Data/Action/Import'" accept=".json" @on-success="reload"></jnpf-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  import { getDataReportList, delDataReport, copy } from '/@/api/onlineDev/dataReport';
  ...
  function handleExport(id) {
    ...
    const url = `${reportServer}/api/datareport/Data/${id}/Actions/Export?token=${token}`;
    downloadByUrl({ url });
  }
