    ...
    schemas: [
      {
        ...
        label: '功能名称',
        component: 'Input',
        componentProps: { placeholder: '功能名称', maxlength: 100 },
        rules: [{ required: true, trigger: 'blur', message: '功能名称不能为空' }],
      },
      {
        field: 'enCode',
        label: '功能编码',
        component: 'Input',
        componentProps: { placeholder: '功能编码', maxlength: 50 },
        rules: [
          { required: true, trigger: 'blur', message: '功能编码不能为空' },
      ...
      },
      {
        ...
        rules: [{ required: true, trigger: 'change', message: '功能分类不能为空' }],
      },
      {
        field: 'enableFlow',
        label: '功能类型',
        ...
        rules: [{ required: true, trigger: 'change', message: '功能类型不能为空', type: 'number' }],
      },
      {
        field: 'sortCode',
        label: '功能排序',
      ...
      },
      {
        ...
        label: '功能说明',
        component: 'Textarea',
        componentProps: { placeholder: '功能说明' },
      },
      {
        field: 'dbLinkId',
        label: '数据连接',
