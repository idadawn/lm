<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :width="800" :title="state.title" :min-height="300" :footer="null" class="notice-modal">
...
<script lang="ts" setup>
  ...
  function init(data) {
    changeLoading(true);
    state.title = data.type == 1 ? '查看消息' : '查看公告';
