  ...
  <div class="page-content-wrapper">
    <div class="page-content-wrapper-center bg-white">
      <a-form :colon="false" labelAlign="right" :labelCol="{ style: { width: '100px' } }" class="right-board-form h-full">
        <a-tabs class="page-content-wrapper-tabs" v-model:activeKey="activeKey" type="card">
              ...
              <a-col :span="24">
                <a-form-item label="系统图标">
                  <div class="img-list">
                    ...
                    <JnpfUploadImgSingle v-model:value="baseForm.navigationIcon" tipText="导航图标" />
                  ...
                  <a-table bordered :dataSource="wxResultsList" :columns="resultsColumns" :pagination="false" size="small">
                    <template #bodyCell="{ column, record }">
                      <template v-if="column.dataIndex === 'synDate'">
                        <p>{{ dayjs(record.synDate).format('YYYY-MM-DD HH:mm') }}</p>
                      </template>
            ...
            <a-row>
              <a-col :span="12">
                <a-form-item label="超级管理员">
                  <jnpf-user-select v-model:value="adminIds" placeholder="请选择超级管理员" multiple />
                </a-form-item>
                <a-form-item label=" ">
        ...
        update(state.baseForm)
          .then(res => {
            ...
            const sysConfigInfo = {
              ...
              navigationIcon: state.baseForm.navigationIcon,
