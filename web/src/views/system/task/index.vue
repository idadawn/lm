    ...
    <div class="page-content-wrapper-center">
      <div class="page-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-ym icon-ym-btn-add" @click="addOrUpdateHandle()">新建任务</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  const columns: BasicColumn[] = [
    ...
    { title: '任务开始时间', dataIndex: 'startTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    { title: '任务结束时间', dataIndex: 'endTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    { title: '最后执行时间', dataIndex: 'lastRunTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
    { title: '下次运行时间', dataIndex: 'nextRunTime', width: 150, format: 'date|YYYY-MM-DD HH:mm' },
