...
<script lang="ts" setup>
    ...
    formConfig: {
      schemas: [
        ...
        },
        {
          ...
          componentProps: { placeholder: '请选择数据连接', allowClear: false, showSearch: true, fieldNames: { options: 'children' }, onChange: onLinkIdChange },
        },
      ],
    },
    actionColumn: {
  ...
  const getUploadUrl = computed(() => `/api/system/DataModel/${unref(linkId)}/Action/Import`);
