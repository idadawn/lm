<template>
  <div class="page-content-wrapper">
      ...
      <div class="page-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <jnpf-upload-btn url="/api/workflow/Engine/flowTemplate/Actions/ImportData" accept=".ffe" @on-success="reload"></jnpf-upload-btn>
          </template>
    ...
    <AssistModal @register="registerAssist" />
...
<script lang="ts" setup>
  ...
  const [registerAssist, { openModal: openAssistModal }] = useModal();
  ...
  function getDropDownActions(record): ActionItem[] {
    return [
      ...
      {
        label: '协管流程',
        ifShow: record.hasAssistBtn === 1,
        onClick: handleAssist.bind(null, record.id),
      },
      {
        label: '复制流程',
        modelConfirm: {
  ...
  function handleAssist(id) {
    openAssistModal(true, { id });
  }
