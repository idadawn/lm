    ...
    schemas: [
      {
        ...
        label: '表单名称',
        component: 'Input',
        componentProps: { placeholder: '表单名称', maxlength: 50 },
        rules: [{ required: true, trigger: 'blur', message: '表单名称不能为空' }],
      },
      {
        field: 'enCode',
        label: '表单编码',
        component: 'Input',
        componentProps: { placeholder: '表单编码', maxlength: 50 },
        rules: [
          { required: true, trigger: 'blur', message: '表单编码不能为空' },
      ...
      },
      {
        ...
        rules: [{ required: true, trigger: 'change', message: '表单类型不能为空', type: 'number' }],
      },
      {
        field: 'flowType',
        label: '表单类别',
        ...
        rules: [{ required: true, trigger: 'change', message: '表单类别不能为空', type: 'number' }],
      ...
      },
      {
        ...
        label: 'Web地址',
        component: 'Input',
        componentProps: { placeholder: 'Web地址', addonBefore: '@/views/' },
        ifShow: ({ values }) => values.formType == 1,
      },
      {
        field: 'appUrlAddress',
        label: 'App地址',
        helpMessage: 'APP地址配置为物理地址，需与代码同步更新',
        component: 'Input',
        componentProps: { placeholder: 'App地址' },
        ifShow: ({ values }) => values.formType == 1,
      },
      {
        field: 'interfaceUrl',
        ...
        component: 'Input',
        componentProps: { placeholder: '接口地址' },
        ifShow: ({ values }) => values.formType == 1,
      },
      {
        field: 'sortCode',
      ...
      },
      {
        ...
        label: '表单说明',
        component: 'Textarea',
        componentProps: { placeholder: '表单说明' },
      },
      {
        field: 'dbLinkId',
        label: '数据连接',
        defaultValue: '0',
        component: 'Select',
        componentProps: { placeholder: '请选择数据库', allowClear: false, showSearch: true, fieldNames: { options: 'children' }, onChange: onDbChange },
